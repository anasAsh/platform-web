...
var alana_platform_facebook_1 = require("alana-platform-facebook");
...
Web.convertToAlana = convertToBotler;
Web.convertFromAlana = convertFromBolter;
exports.default = Web;
...
function convertFromBolter(message) {
    return alana_platform_facebook_1.mapInternalToFB(message);
}
