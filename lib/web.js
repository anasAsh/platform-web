...
var botler_platform_facebook_1 = require("botler-platform-facebook");
...
var Web = (function () {
    function Web(botler, port, fbport) {
        ...
        this.localApp.post('/api/receive', function (req, res, next) {
            ...
            var message = convertToBotler(req.body);
            var fbMessage = {
                recipient: {
                    id: PAGEID,
                },
...
Web.convertToBotler = convertToBotler;
Web.convertFromBolter = convertFromBolter;
Object.defineProperty(exports, "__esModule", { value: true });
exports.default = Web;
function convertToBotler(receivedMessage) {
    var message;
...
exports.convertToBotler = convertToBotler;
function convertFromBolter(message) {
    return botler_platform_facebook_1.mapInternalToFB(message);
}
exports.convertFromBolter = convertFromBolter;
